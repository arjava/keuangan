...
import '../model/response_add_trx.dart';
...
class PindahPage extends StatefulWidget {
  ...
  const PindahPage(
      {Key? key, this.listOutlet, this.restorationId, this.listCurrency})
      : super(key: key);
...
class _PindahPageState extends State<PindahPage> with RestorationMixin {
  String? dateSelected = "";
  DateTime? nowDate;
  ...
  List<String?>? listOutletsNameTo = ['Outlet', 'Outlet 2', 'Outlet 3'];
  List<String?>? listCurrencyName = ['IDR', 'USD', 'SGD'];

  String? selectedValueOutlet = "";
  String? selectedValueOutletTo = "";
  ...
  void initState() {
    ...
    listOutletsNameTo = widget.listOutlet?.map((e) => e?.outletName).toList();
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButtonFormField2(
                      ...
                      onChanged: (value) {
                        selectedValueOutletTo = value.toString();
                      },
                      onSaved: (value) {
                        selectedValueOutletTo = value.toString();
                      },
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        if (selectedValueOutletTo!.isEmpty) {
                          showToastError("please select outlet tujuan");
                          return;
                        }
                        ...
                        Object response = await _trxApiProvider.addTrx(
                            ...
                            int.parse(
                                listOutlet![listOutlet!.indexWhere((element) => element?.outletName == selectedValueOutlet)]!
                                    .id
                                    .toString()),
                            int.parse(listOutlet![listOutlet!.indexWhere((element) =>
                                    element?.outletName == selectedValueOutletTo)]!
                                .id
                                .toString()),
                            dateSelected,
