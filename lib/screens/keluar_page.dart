...
class KeluarPage extends StatefulWidget {
  ...
  const KeluarPage(
      {Key? key, this.listOutlet, this.listCurrency, this.restorationId})
      : super(key: key);
...
class _KeluarPageState extends State<KeluarPage> with RestorationMixin {
  String? dateSelected = "";
  DateTime? nowDate;
  ...
  var ctlFieldJudul = TextEditingController(text: "");
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        String base64Encodep1(List<int> bytes) =>
                            base64.encode(bytes);
                        TrxApiProvider trxApiProvider = TrxApiProvider();
                        Object response = await trxApiProvider.addTrx(
                            2,
                            ...
                            "${ctlFieldJudul.text}-${ctlFieldKeterangan.text}",
